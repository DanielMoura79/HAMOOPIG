    ...
    while(TRUE) /// LOOP PRINCIPAL ///
    {
		...
		if(gRoom==2) //TELA DE APRESENTACAO -------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				VDP_setTileMapEx(BG_A,bg_title_bga1.tilemap,TILE_ATTR_FULL(PAL1,0,FALSE,FALSE,gInd_tileset),0,0,0,0,40,28,DMA_QUEUE);
				VDP_setPalette(PAL1, bg_title_bga1.palette->data);
				gInd_tileset += bg_title_bga1.tileset->numTile;
				
				VDP_setBackgroundColor(15); //Range 0-63 //4 Paletas de 16 cores = 64 cores
				
				GE[1].sprite = SPR_addSpriteExSafe(&bone_terry, 111, 134, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
			...
			if(gFrames==16*1)
			{
				...
				VDP_setTileMapEx(BG_A,bg_title_bga2.tilemap,TILE_ATTR_FULL(PAL1,0,FALSE,FALSE,gInd_tileset),0,0,0,0,40,28,DMA_QUEUE);
			...
			if(gFrames==16*2)
			{
				...
				VDP_setTileMapEx(BG_A,bg_title_bga3.tilemap,TILE_ATTR_FULL(PAL1,0,FALSE,FALSE,gInd_tileset),0,0,0,0,40,28,DMA_QUEUE);
			...
			if(gFrames==16*3)
			{
				...
				VDP_setTileMapEx(BG_A,bg_title_bga4.tilemap,TILE_ATTR_FULL(PAL1,0,FALSE,FALSE,gInd_tileset),0,0,0,0,40,28,DMA_QUEUE);
		...
		if(gRoom==3) //CHAR SELECT ----------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				P[2].id = 1; cursorP2_ID = 1; //terry selecao inicial
				...
				//icon VS
				GE[1].sprite = SPR_addSpriteExSafe(&spr_icon_vs, 136, 104, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setVRAMTileIndex(GE[1].sprite, 1461); //define uma posicao especifica para o GFX na VRAM
				VDP_setPalette(PAL1, spr_icon_vs.palette->data);
				
				//Retratos grandes
				GE[3].sprite = SPR_addSpriteExSafe(&spr_terry_001,  32, 64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				VDP_setPalette(PAL2, spr_terry_001.palette->data);
				GE[4].sprite = SPR_addSpriteExSafe(&spr_terry_001, 192, 64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				VDP_setPalette(PAL3, spr_terry_001.palette->data);
				SPR_setHFlip(GE[4].sprite, TRUE);
				
				//Nomes
				GE[5].sprite = SPR_addSpriteExSafe(&spr_terry_name,  32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				GE[6].sprite = SPR_addSpriteExSafe(&spr_terry_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
			...
			*/
			...
			if(moverCursorP1==1) //P1
			{
				...
				if(cursorP1coluna== 3 && cursorP1linha==1){ cursorP1_ID= 3; }
				if(cursorP1coluna== 4 && cursorP1linha==1){ cursorP1_ID= 4; }
				if(cursorP1coluna== 5 && cursorP1linha==1){ cursorP1_ID= 5; }
				if(cursorP1coluna== 6 && cursorP1linha==1){ cursorP1_ID= 6; }
				if(cursorP1coluna== 7 && cursorP1linha==1){ cursorP1_ID= 7; }
				if(cursorP1coluna== 8 && cursorP1linha==1){ cursorP1_ID= 8; }
				if(cursorP1coluna== 9 && cursorP1linha==1){ cursorP1_ID= 9; }
				if(cursorP1coluna==10 && cursorP1linha==1){ cursorP1_ID=10; }
				if(cursorP1coluna==11 && cursorP1linha==1){ cursorP1_ID=11; }
				P[1].id = cursorP1_ID;
				...
				if(cursorP1_ID==2)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_andy_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_andy_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_andy_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==3)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_joe_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_joe_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_joe_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==4)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_richard_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_richard_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_richard_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==5)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_michael_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_michael_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_michael_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==6)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_duck_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_duck_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_duck_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==7)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_tung_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_tung_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_tung_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==8)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_hwa_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_hwa_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_hwa_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==9)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_raiden_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_raiden_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_raiden_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==10)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_billy_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_billy_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_billy_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP1_ID==11)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_geese_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL2, spr_geese_001.palette->data);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_geese_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
			}//---end P1
			...
			if(moverCursorP2==1) //P2
			{
				...
				if(cursorP2coluna== 3 && cursorP2linha==1){ cursorP2_ID= 3; }
				if(cursorP2coluna== 4 && cursorP2linha==1){ cursorP2_ID= 4; }
				if(cursorP2coluna== 5 && cursorP2linha==1){ cursorP2_ID= 5; }
				if(cursorP2coluna== 6 && cursorP2linha==1){ cursorP2_ID= 6; }
				if(cursorP2coluna== 7 && cursorP2linha==1){ cursorP2_ID= 7; }
				if(cursorP2coluna== 8 && cursorP2linha==1){ cursorP2_ID= 8; }
				if(cursorP2coluna== 9 && cursorP2linha==1){ cursorP2_ID= 9; }
				if(cursorP2coluna==10 && cursorP2linha==1){ cursorP2_ID=10; }
				if(cursorP2coluna==11 && cursorP2linha==1){ cursorP2_ID=11; }
				P[2].id = cursorP2_ID;
				...
				if(cursorP2_ID==2)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_andy_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_andy_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_andy_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==3)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_joe_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_joe_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_joe_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==4)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_richard_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_richard_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_richard_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==5)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_michael_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_michael_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_michael_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==6)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_duck_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_duck_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_duck_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==7)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_tung_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_tung_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_tung_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==8)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_hwa_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_hwa_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_hwa_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==9)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_raiden_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_raiden_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_raiden_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==10)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_billy_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_billy_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_billy_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				if(cursorP2_ID==11)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_geese_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
					VDP_setPalette(PAL3, spr_geese_001.palette->data);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_geese_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				}
				SPR_setHFlip(GE[4].sprite, TRUE);
				//SPR_setHFlip(GE[6].sprite, TRUE);
			}//---end P2
			...
			if(cursorP1ConfirmFX<cursorConfirmTimer)
			{
				if(cursorP1ConfirmFX>0)
				{
					...
					if(mudarcor==1)
					{
						...
						{
							if(cursorP1ColorChoice==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_1a.palette->data); }
							if(cursorP1ColorChoice==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_1a.palette->data); }
							if(cursorP1ColorChoice==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_1a.palette->data); }
							if(cursorP1ColorChoice==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_1a.palette->data); }
							if(cursorP1ColorChoice==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_1a.palette->data); }
							if(cursorP1ColorChoice==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_1a.palette->data); }
							if(cursorP1ColorChoice==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_1a.palette->data); }
							if(cursorP1ColorChoice==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_1a.palette->data); }
						}
						if(cursorP1_ID==2) //gillius
						{
							/*
							if(cursorP1ColorChoice==1){ VDP_setPalette(PAL2, spr_gillius_pal1.palette->data); }
							if(cursorP1ColorChoice==2){ VDP_setPalette(PAL2, spr_gillius_pal2.palette->data); }
							if(cursorP1ColorChoice==3){ VDP_setPalette(PAL2, spr_gillius_pal3.palette->data); }
							if(cursorP1ColorChoice==4){ VDP_setPalette(PAL2, spr_gillius_pal4.palette->data); }
							if(cursorP1ColorChoice==5){ VDP_setPalette(PAL2, spr_gillius_pal5.palette->data); }
							if(cursorP1ColorChoice==6){ VDP_setPalette(PAL2, spr_gillius_pal6.palette->data); }
							if(cursorP1ColorChoice==7){ VDP_setPalette(PAL2, spr_gillius_pal7.palette->data); }
							if(cursorP1ColorChoice==8){ VDP_setPalette(PAL2, spr_gillius_pal8.palette->data); }
							*/
						}
			...
			if(cursorP2ConfirmFX<cursorConfirmTimer)
			{
				if(cursorP2ConfirmFX>0)
				{
					...
					if(mudarcor==1)
					{
						...
						{
							if(cursorP2ColorChoice==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_1a.palette->data); }
							if(cursorP2ColorChoice==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_1a.palette->data); }
							if(cursorP2ColorChoice==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_1a.palette->data); }
							if(cursorP2ColorChoice==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_1a.palette->data); }
							if(cursorP2ColorChoice==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_1a.palette->data); }
							if(cursorP2ColorChoice==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_1a.palette->data); }
							if(cursorP2ColorChoice==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_1a.palette->data); }
							if(cursorP2ColorChoice==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_1a.palette->data); }
						}
						if(cursorP2_ID==2) //gillius
						{
							/*
							if(cursorP2ColorChoice==1){ VDP_setPalette(PAL3, spr_gillius_pal1.palette->data); }
							if(cursorP2ColorChoice==2){ VDP_setPalette(PAL3, spr_gillius_pal2.palette->data); }
							if(cursorP2ColorChoice==3){ VDP_setPalette(PAL3, spr_gillius_pal3.palette->data); }
							if(cursorP2ColorChoice==4){ VDP_setPalette(PAL3, spr_gillius_pal4.palette->data); }
							if(cursorP2ColorChoice==5){ VDP_setPalette(PAL3, spr_gillius_pal5.palette->data); }
							if(cursorP2ColorChoice==6){ VDP_setPalette(PAL3, spr_gillius_pal6.palette->data); }
							if(cursorP2ColorChoice==7){ VDP_setPalette(PAL3, spr_gillius_pal7.palette->data); }
							if(cursorP2ColorChoice==8){ VDP_setPalette(PAL3, spr_gillius_pal8.palette->data); }
							*/
						}
						//Movimentacao de Sprite do cursor de cor
...
void FUNCAO_INICIALIZACAO()
{
	...
	if(P[1].id==2){ GE[16].sprite = SPR_addSpriteExSafe(&spr_terry_000,  0, 24, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC); }
	...
	if(P[2].id==2){ GE[17].sprite = SPR_addSpriteExSafe(&spr_terry_000,  304, 24, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC); }
	...
	if(P[1].id==1 && P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_1a.palette->data); } //haohmaru
	if(P[1].id==1 && P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_1a.palette->data); } //haohmaru
	
	/*
	if(P[1].id==2 && P[1].palID==1){ VDP_setPalette(PAL2, spr_gillius_pal1.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==2){ VDP_setPalette(PAL2, spr_gillius_pal2.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==3){ VDP_setPalette(PAL2, spr_gillius_pal3.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==4){ VDP_setPalette(PAL2, spr_gillius_pal4.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==5){ VDP_setPalette(PAL2, spr_gillius_pal5.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==6){ VDP_setPalette(PAL2, spr_gillius_pal6.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==7){ VDP_setPalette(PAL2, spr_gillius_pal7.palette->data); } //gillius
	if(P[1].id==2 && P[1].palID==8){ VDP_setPalette(PAL2, spr_gillius_pal8.palette->data); } //gillius
	*/
	
	if(P[2].id==1 && P[2].palID==1){ VDP_setPalette(PAL3, spr_terry_pal1.palette->data); } //terry
	if(P[2].id==1 && P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_1a.palette->data); } //haohmaru
	if(P[2].id==1 && P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_1a.palette->data); } //haohmaru
	
	/*
	if(P[2].id==2 && P[2].palID==1){ VDP_setPalette(PAL3, spr_gillius_pal1.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==2){ VDP_setPalette(PAL3, spr_gillius_pal2.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==3){ VDP_setPalette(PAL3, spr_gillius_pal3.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==4){ VDP_setPalette(PAL3, spr_gillius_pal4.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==5){ VDP_setPalette(PAL3, spr_gillius_pal5.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==6){ VDP_setPalette(PAL3, spr_gillius_pal6.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==7){ VDP_setPalette(PAL3, spr_gillius_pal7.palette->data); } //gillius
	if(P[2].id==2 && P[2].palID==8){ VDP_setPalette(PAL3, spr_gillius_pal8.palette->data); } //gillius
	*/
